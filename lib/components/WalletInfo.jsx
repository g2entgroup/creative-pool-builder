    ...
    innerContent = (
      <>
        <div className='leading-snug text-highlight-3 trans'>
          <a className='text-highlight-3 hover:text-purple-300 overflow-ellipsis block w-full no-underline'>
            {shorten(address)}
          </a>
        ...
        <button
          ...
          className={classnames(
            'text-default hover:text-white trans ml-2 outline-none focus:outline-none',
